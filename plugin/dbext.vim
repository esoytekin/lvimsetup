...
let g:dbext_default_profile_sqlite_window_file = 'type=SQLITE:SQLITE_bin=/usr/bin/sqlite3:dbname=/home/emrahsoytekin/Documents/Development/personal/window_analysis/backend/files_api/databases/dev.db'
let g:dbext_default_profile_sqlite_window_auth = 'type=SQLITE:SQLITE_bin=/usr/bin/sqlite3:dbname=/home/emrahsoytekin/Documents/Development/personal/window_analysis/backend/auth_api/databases/dev.db'
let g:dbext_default_profile_sqlite_window_delay = 'type=SQLITE:SQLITE_bin=/usr/bin/sqlite3:dbname=/home/emrahsoytekin/Documents/Development/personal/window_analysis/backend/delay_analyze_api/database/dev.db'
let g:dbext_default_profile_sqlite_babasultan = 'type=SQLITE:SQLITE_bin=/usr/bin/sqlite3:dbname=/home/emrahsoytekin/Documents/Development/personal/babasultan/backend/schema/dining.db'
" let g:dbext_default_profile_postgre_istanbul_aioc = 'type=PGSQL:user=aioc:passwd=aioc:dbname=aioc:host=10.20.40.237'
let g:dbext_default_profile_postgre_lunatech = 'type=PGSQL:user=postgres:dbname=lunatech_imdb:passwd=postgres:host=localhost:port=5432'
"}}}
...
func! dbext#OpenSqlEditor()
    ...
    nnoremap <buffer> <silent><CR> :DBSelectFromTableTopX<CR>
